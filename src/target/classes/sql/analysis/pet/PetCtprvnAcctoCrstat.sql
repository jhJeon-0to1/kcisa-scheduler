INSERT INTO
    analysis_model.pet_ctprvn_accto_crstat
...
FROM
    (SELECT
       ...
       , (SELECT POPLTN_CO
          ...
          WHERE
                P.BASE_YM = R1.BASE_YM
            AND P.CTPRVN_CD = R1.CTPRVN_CD) AS POPLTN_CO
     FROM
         colct_pet_regist_crstat AS R1
     WHERE
         BASE_YM = ?
...
ON DUPLICATE KEY UPDATE
                   ...
                   , DOG_REGIST_CO                         = VALUES(DOG_REGIST_CO)
                   , CAT_REGIST_CO                         = VALUES(CAT_REGIST_CO)
                   , POPLTN_PER_PET_REGIST_CO              = VALUES(POPLTN_PER_PET_REGIST_CO)
                   , POPLTN_PER_DOG_REGIST_CO              = VALUES(POPLTN_PER_DOG_REGIST_CO)
                   , POPLTN_PER_CAT_REGIST_CO              = VALUES(POPLTN_PER_CAT_REGIST_CO)
                   , PET_HSPT_CO                           = VALUES(PET_HSPT_CO)
                   , PET_BTY_FCLTY_CO                      = VALUES(PET_BTY_FCLTY_CO)
                   , PET_CONSGN_MANAGE_FCLTY_CO            = VALUES(PET_CONSGN_MANAGE_FCLTY_CO)
                   , PET_ACP_CTLSTT_CO                     = VALUES(PET_ACP_CTLSTT_CO)
                   , PET_RELATE_FCLTY_CO                   = VALUES(PET_RELATE_FCLTY_CO)
                   , POPLTN_PER_PET_HSPT_CO                = VALUES(POPLTN_PER_PET_HSPT_CO)
                   , POPLTN_PER_PET_BTY_FCLTY_CO           = VALUES(POPLTN_PER_PET_BTY_FCLTY_CO)
                   , POPLTN_PER_PET_CONSGN_MANAGE_FCLTY_CO = VALUES(POPLTN_PER_PET_CONSGN_MANAGE_FCLTY_CO)
                   , POPLTN_PER_PET_ACP_CTLSTT_CO          = VALUES(POPLTN_PER_PET_ACP_CTLSTT_CO)
