insert into movie_mt_accto_viewng_crstat
(BASE_YM, BASE_YEAR, BASE_MT, CTPRVN_CD, CTPRVN_NM, MOVIE_ADNC_CO, POPLTN_PER_MOVIE_ADNC_CO, EXPNDTR_PRICE, SEAT_PER_EXPNDTR_PRICE, METRP_AREA_AT)
SELECT
