...
(BASE_YM, BASE_YEAR, BASE_MT, CTPRVN_CD, CTPRVN_NM, LRGE_THEAT_CO, MIDDL_THEAT_CO, SMALL_THEAT_CO)
SELECT
    BASE_YM
    ...
    , SUM(IF(FCLTY_SEAT_CO > 300 and FCLTY_SEAT_CO < 1000, 1, 0)) as MIDDL_THEAT_CO
...
FROM (
    ...
    ON A.PBLPRFR_FCLTY_ID  = B.PBLPRFR_FCLTY_ID
