...
(BASE_DE, BASE_YEAR, BASE_MT, BASE_DAY, CTPRVN_CD, CTPRVN_NM, SPORTS_VIEWNG_NMPR_CO, POPLTN_PER_VIEWNG_NMPR_CO, KLEA_VIEWNG_NMPR_CO, KBO_VIEWNG_NMPR_CO, KBL_VIEWNG_NMPR_CO, WKBL_VIEWNG_NMPR_CO, KOVO_VIEWNG_NMPR_CO)
SELECT
    BASE_DE
    , BASE_YEAR
    , BASE_MT
