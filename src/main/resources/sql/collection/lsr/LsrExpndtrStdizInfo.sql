...
(BASE_DE, BASE_YEAR, BASE_MT, BASE_DAY, CTPRVN_CD, CTPRVN_NM, INDUTY_TY_CD, INDUTY_TY_NM, FLCTTN_RT, COLCT_DE)
VALUES
(?, ?, ?, ?, ?, (SELECT CTPRVN_NM FROM CTPRVN_INFO WHERE CTPRVN_CD = ?), ?, ?, ?, DATE_FORMAT(NOW(), '%Y%m%d'))
