INSERT INTO kcisa.pblprfr_viewing_info
(BASE_DE, BASE_YEAR, BASE_MT, BASE_DAY, CTPRVN_CD, CTPRVN_NM, GENRE_CD, GENRE_NM, PBLPRFR_RASNG_CUTIN_CO, PBLPRFR_CO, PBLPRFR_STGNG_CO, PBLPRFR_SALES_PRICE, PBLPRFR_VIEWNG_NMPR_CO, COLCT_DE)
