...
public class KobisConfiguration {
        ...
        public void start() throws SchedulerException {
                JobDetail kobisRegionJobDetail = JobBuilder.newJob(KobisRegionJob.class)
                                .withIdentity("영화 지역별 일별", "TEST")
                                .build();
                JobDetail kobisDailyJobDetail = JobBuilder.newJob(KobisDailyJob.class).withIdentity("영화 일별 매출액", "TEST")
                                .build();
                JobDetail kobisMovieJobDetail = JobBuilder.newJob(KobisMovieJob.class).withIdentity("영화 정보", "TEST")
                                .build();
                ...
                // scheduler.scheduleJob(kobisMovieJobDetail, kobisMovieTrigger); // 영화 정보
        }
}
