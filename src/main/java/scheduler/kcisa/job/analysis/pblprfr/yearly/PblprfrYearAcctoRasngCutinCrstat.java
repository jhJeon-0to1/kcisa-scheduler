...
@Component
public class PblprfrYearAcctoRasngCutinCrstat extends QuartzJobBean {
    String tableName = "pblprfr_year_accto_rasng_cutin_crstat";
    ...
    public PblprfrYearAcctoRasngCutinCrstat(YearlyAnalysisFlagService flagService) {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        JobUtils.executeAnalysisJob(context, tableName, checkList, flagDate, ScheduleInterval.YEARLY, jobData -> {
            ...
            String query = Utils.getSQLString("src/main/resources/sql/analysis/pblprfr/PblprfrYearAcctoRasngCutinCrstat.sql");
